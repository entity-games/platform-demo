...
var globalLayoutData = {};
var layoutData = null;
var modelData = null;

exports.initScale = function () {
	console.log("Init scale: ", window.innerHeight, window.innerWidth);
			...
			MainMenuScene: {
				ui: {
					...
					menu: {
						...
						padding: 30,
						fistIndicatorX: globalLayoutData.halfScreenWidth - 260,
			...
			CharacterSelectScene: {
				ui: {
					...
					headshots: {
						...
						y: 60,
						padding: 15,
						height: globalLayoutData.halfScreenHeight * 0.2,
						width: globalLayoutData.halfScreenHeight * 0.2,
						maxPerRow: 3,
					},
					character: {
						x: 0,
						...
						originX: 0,
						originY: 1.0,
						width: globalLayoutData.screenWidth * 0.66,
					...
					characterInfo: {
						...
						atkStats: {
							...
							originY: 0,
							x: globalLayoutData.halfScreenWidth + 20,
							y: globalLayoutData.halfScreenHeight + 90,
							padding: 42,
							bitmapFontId: "verdana64",
							fontSize: 44,
							statList: {
								...
								x: globalLayoutData.halfScreenWidth + 20,
								y: globalLayoutData.halfScreenHeight + 170,
								padding: 55,
								sidePadding: 70,
								textOffset: 30,
							},
						...
						defStats: {
							...
							originY: 0,
							x:
								globalLayoutData.halfScreenWidth +
								globalLayoutData.halfScreenWidth / 2 +
								40,
							y: globalLayoutData.halfScreenHeight + 90,
							iconScale: 1.0,
							padding: 42,
				...
				graphics: {
					p1: {
						...
						mask: [
							...
							{ x: globalLayoutData.screenWidth * 0.33, y: globalLayoutData.screenHeight },
							{ x: globalLayoutData.screenWidth * 0.66, y: 0 },
						],
					},
					p2: {
...
function getSceneLayoutData(sceneName) {
	return _getlayoutData().sceneLayouts[sceneName];
}

function getModalLayoutData(modalName) {
	return _getModelData()[modalName];
}
